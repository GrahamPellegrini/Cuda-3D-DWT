...
#include "../include/savecsvSingle.h"
...
int main(int argc, char *argv[]) {
    ...
    if (argc != 4) { // Expecting 3 arguments: csv_file, output_coefficients, db_num
        std::cerr << "Usage: " << argv[0] << " <csv_file> <output_coefficients> <db_num>" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    save_csv(output_coefficients, volume, depth, rows, cols);
